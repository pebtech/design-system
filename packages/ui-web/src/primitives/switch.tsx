...
const colors = {
  ...
  brand: [
    '[--switch-bg-ring:var(--color-brand)]/90 [--switch-bg:var(--color-brand)]',
    '[--switch-ring:var(--color-brand)]/90 [--switch-shadow:var(--color-black)]/10 [--switch:white]',
  ],
  zinc: [
...
const thumbSizes = {
  sm: 'size-3.5 group-data-checked:translate-x-3',
  md: 'size-4.5 group-data-checked:translate-x-4',
  lg: 'size-7 group-data-checked:translate-x-7',
}
  ...
  return (
    ...
    >
      <span
        ...
        className={cn(
          // Basic layout
          'pointer-events-none relative flex items-center justify-center rounded-full transition duration-200 ease-in-out',
          thumbSizes[size],
